...
if(isset($_POST['submit'])){
    ...
    $q = "INSERT INTO `admin_login` (`Admin_Name`,`Admin_Password`) VALUES ('$name','$password')";
                    ...
                    <form action="#" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class=" login-btm login-button">
                                     <p class="text-white fw-bold p-log">Have an account?<a href="./Admin_Login.php" class="">Log In</a></p>
                                </div>
